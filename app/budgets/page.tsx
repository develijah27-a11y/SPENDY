              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl text-slate-400 hover:text-slate-700 dark:hover:text-white transition-colors cursor-pointer touch-target flex items-center justify-center"
                    aria-label={`Edit ${b.category.name} monthly budget limit`}
                  >
        ...
        >
          <div className="w-full max-w-md rounded-t-[28px] sm:rounded-3xl bg-white dark:bg-[#0E1628] border-t sm:border border-slate-200 dark:border-slate-800 shadow-2xl p-5 sm:p-6 space-y-4 pb-safe">
            <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
              <h2 id="budget-dialog-title" className="text-base font-black text-slate-950 dark:text-white">
                Set Monthly Budget
              </h2>
              <button
            ...
            <form onSubmit={handleSaveBudget} className="space-y-4 text-xs">
              <div>
                <label htmlFor="budget-target-category" className="block text-xs font-bold text-slate-900 dark:text-white mb-1">
                  Budget Target
                </label>
                <select
                  id="budget-target-category"
              ...
              <div>
                <label htmlFor="budget-planned-amount" className="block text-xs font-bold text-slate-900 dark:text-white mb-1">
                  Monthly Limit (UGX)
                </label>
                <input
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-200 dark:border-slate-800">
                <button
                  type="button"
                  onClick={() => setShowModal(false)}
                  className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-bold transition-colors cursor-pointer touch-target flex items-center justify-center"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold transition-colors shadow-sm cursor-pointer touch-target flex items-center justify-center"
                >
                  Save Budget
                </button>
              </div>
