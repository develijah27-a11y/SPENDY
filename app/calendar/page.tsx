  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-black/15 dark:border-white/15">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-xs transition-all cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div className="p-4 rounded-3xl bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-slate-800">
        ...
        <div className="p-4 rounded-3xl bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-slate-800 bg-amber-500/[0.04]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-3xl bg-white dark:bg-[#0B0F19] p-5 sm:p-6 border border-slate-200 dark:border-slate-800 space-y-4">
          {/* Month Navigator */}
        ...
        <div className="rounded-3xl bg-white dark:bg-[#0B0F19] p-5 sm:p-6 border border-slate-200 dark:border-slate-800 space-y-4">
